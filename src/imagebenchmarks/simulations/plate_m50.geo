...
aspect_ratio = 1.3;
plate_width = 100e-3;
plate_height = plate_width*aspect_ratio; // Must be greater than plate width
...
hole_sect_nodes = 3 + 2*mesh_ref; // Must be odd
plate_rad_nodes = 3 + 2*mesh_ref;
plate_diff_nodes = 1 + 2*mesh_ref; // numbers of nodes along the rectangular extension
